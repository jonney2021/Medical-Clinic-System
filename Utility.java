...
/**
 ...
 and be able to get the user's input.
 */
...
public class Utility {
    ...
    /**
     * Read a menu option entered by the keyboard, value: range from 0 to 8
     * @return 0——8
     */
     ...
     * it will return the specified default value; otherwise, it will return the input character
     * @param defaultValue 
    ...
    /**
     * Read the integer or default value entered by the keyboard, if you press Enter directly, 
    ...
    /**
     * Read the string or default value of the specified length entered by the keyboard, 
     * if you press Enter directly, return the default value, otherwise return the string
     * @param limit 
     * @param defaultValue 
     * @return String value
     */
    ...
    private static String readKeyBoard(int limit, boolean blankReturn) {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (line.length() == 0) {
                if (blankReturn) return line;//if blankReturn=true,return blank line
                else continue; //if blankReturn=false, empty strings are not accepted, content must be entered
            }
